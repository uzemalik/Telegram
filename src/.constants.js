module.exports = Object.freeze({
  TOKEN: '1066241990:AAH0sv7VLeut-gO85DvBu05hlhzozd9-ZE4', //required
  ARIA_SECRET: 'bhadoo', //change as per needs.
  ARIA_DOWNLOAD_LOCATION: '/app/downloads)', //-leave as it is
  INDEX_DOMAIN: 'https://weathered-unit-c84a.uzemalik.workers.dev/Telegram%20Torrent/', // replace with your index domain. use https://github.com/ParveenBhadooOfficial/go-drive
  ...
  GDRIVE_PARENT_DIR_ID:  '1dKtY_9IlJzPqvyVuMdzMQjsqLj3jcVS8', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboWePmo53DnVr3xkAYiojP9
  SUDO_USERS: [874739378],	// Telegram user IDs. These users can use the bot in any chat. required, get it using https://t.me/YourTGid_Bot
  AUTHORIZED_CHATS: [-1001255280351],	// Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
  ...
  DOWNLOAD_NOTIFY_TARGET: {  // Information about the web service to notify on download completion. not required
    ...
    COMMANDS_USE_BOT_NAME: {
      ...
      NAME: "@gdtdbot" //Enter your Bot Username here if above is set to true.
    },
  IS_TEAM_DRIVE: true
});
